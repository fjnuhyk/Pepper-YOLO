...
class HUBTrainingSession:
    ...
    def load_model(self, model_id):
        ...
        if not self.model.data:
            raise ValueError(emojis("鉂?The specified HUB model does not exist"))
        ...
        LOGGER.info(f"{PREFIX}View model at {self.model_url} 馃殌")
    ...
    def _set_train_args(self, **kwargs):
        ...
        if self.model.is_trained():
            ...
            raise ValueError(emojis(f"Model is already trained and uploaded to {self.model_url} 馃殌"))
    ...
    def upload_model(
        ...
        if Path(weights).is_file():
            ...
            LOGGER.warning(f"{PREFIX}WARNING 鈿狅笍 Model upload issue. Missing model {weights}.")
